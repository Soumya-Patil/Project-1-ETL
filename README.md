...
- A total of 3 tables were created , and the insertions to the database were made using Pandas. The Schema and Query used can be found in the Resources folder.
